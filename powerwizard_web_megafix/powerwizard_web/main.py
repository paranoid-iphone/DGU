...
def build_real_snapshot():
    ...
    try:
        print("[POLL] real mode — polling devices...")
        with _poll_lock:
        ...
        import traceback
        print("[REAL BACKEND ERROR] {}: {}".format(type(e).__name__, e))
